...
// $nilai_query = mysqli_query($conn, "SELECT * FROM nilai WHERE siswa_id = '$siswa_id' AND semester = 'Ganjil'");
...
// $rapor_query = mysqli_query($conn, "SELECT * FROM rapor WHERE siswa_id = '$siswa_id' AND semester = 'Ganjil'");
