...
<div class="page">
    ...
    <div class="ttd">
        <?php if (!empty($rapor['foto_catatan_tambahan'])): ?>
            <img src="http://localhost/rapor_online/uploads/<?= htmlspecialchars($rapor['foto_catatan_tambahan']) ?>" width="200">
            <!-- <img src="file:///C:/xampp/htdocs/rapor_online/uploads/<?= htmlspecialchars($rapor['foto_catatan_tambahan']) ?>" style="width:200px;"> -->


            <!-- <img src="../uploads/<?= htmlspecialchars($rapor['foto_catatan_tambahan']) ?>" alt="Tanda Tangan Kepala Sekolah"> -->
        <?php else: ?>
...
<div class="page">
    ...
    <div class="ttd">
        <?php if (!empty($rapor['foto_kepsek'])): ?>
            <img src="http://localhost/rapor_online/uploads/<?= htmlspecialchars($rapor['foto_kepsek']) ?>" width="200">
            <!-- <img src="file:///C:/xampp/htdocs/rapor_online/uploads/<?= htmlspecialchars($rapor['foto_kepsek']) ?>" style="width:200px;"> -->

            <!-- <img src="http://localhost/rapor_online/uploads/<?= htmlspecialchars($rapor['foto_kepsek']) ?>" style="width:200px;"> -->
        <?php else: ?>
            <p><i>Belum ada tanda tangan.</i></p>
        <?php endif; ?>
